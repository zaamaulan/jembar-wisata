...
@section('content')
    <section class="mt-20 flex flex-col container mx-auto my-28">
        <div class="flex flex-col gap-y-3">
            ...
            <p class="text-gray-500 text-lg font-medium text-left"></p>
        </div>
        <div class="container mx-auto flex justify-between capitalize items-center w-10/12">
            <a href="#"
                class="shadow-xl hover:shadow-2xl hover:text-sky-500 transition-all ease-in-out rounded-lg h-96 border-solid border-2 border-neutral-100 w-60">
